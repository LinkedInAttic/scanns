...
import com.linkedin.nn.Types.{Item, ItemId, ItemIdDistancePair}
import com.linkedin.nn.distance.{Distance, DistanceMetric}
...
class BruteForceNearestNeighborModel(val uid: String = Identifiable.randomUID("BruteForceNNS"))
  ...
  // [[com.linkedin.nn.algorithm.BruteForceNNS#createModel]] for details
